...
const SKILL_DATA = {
  default:{
    title: 'スキル紹介',
    desc: '左のゲージをクリックして詳細を表示します。<br><br>数値の目安▼<br>10%：チュートリアル完了<br>30%：研修完了～実務開始レベル<br>50%：実務1年相当<br>70%：実務3年相当<br>100%：ﾁｮｯﾄﾃﾞｷﾙ'
  },
  html:{
    title: 'html&CSS',
  ...
  ruby:{
    title: 'Ruby on Rails',
    desc: 'Progate一周した程度です。基本的な文法・構成は理解していますが、まだ使えるレベルではありません。'
  },
  python:{
    title: 'python',
    desc: 'Progate一周した程度です。基本的な文法は理解していますが、まだ使えるレベルではありません。'
  },
  wp:{
    title: 'WordPress',
